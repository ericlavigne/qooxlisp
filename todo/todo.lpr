...
(define-project :name :todo
  :modules (list (make-instance 'module :name "todo-main.lisp")
                 (make-instance 'module :name "../INSTALL.txt")
                 (make-instance 'module :name "todo-ui.lisp"))
  ...
  :on-initialization 'qooxlisp::serve-todo
